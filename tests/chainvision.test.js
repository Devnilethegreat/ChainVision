...
const { ChainVision, ChainVisionCore } = require('../src/index');

describe('ChainVisionCore', () => {
  let core;
  beforeEach(() => { core = new ChainVisionCore(0.75); });
...
describe('ChainVision', () => {
  test('run resolves to true', async () => {
    const app = new ChainVision();
