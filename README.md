# ChainVision: Blockchain data visualisation platform with AI-driven insight extraction Implementation
> Advanced javascript solution leveraging modern architecture patterns and cutting-edge AI technology.

ChainVision transforms raw on-chain data into interactive force-directed graphs and time-series charts, using LLM-powered narration to explain detected patterns to non-technical stakeholders.

ChainVision's key benefits include:
...
```bash
git clone https://github.com/Devnilethegreat/ChainVision.git
cd ChainVision
```
...
- **2025-09-07** — Expand test coverage for edge cases
